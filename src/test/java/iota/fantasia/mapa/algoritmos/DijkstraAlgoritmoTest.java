...
class DijkstraAlgoritmoTest {
    ...
    @Test
    void testEncontrarCaminoMasCorto_CaminoDirecto() {
    ...
    @Test
    void testEncontrarCaminoMasCorto_CaminoIndirecto() {
    ...
    @Test
    void testEncontrarCaminoMasCorto_DestinoIgualOrigen() {
    ...
    @Test
    void testEncontrarCaminoMasCorto_CaminoInexistente() {
    ...
    @Test
    void testEncontrarCaminoMasCorto_NodosInvalidos() {
